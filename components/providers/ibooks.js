...
function findBooksDbPath() {
  console.log('findBooksDbPath is now TRIGGERED!');
  console.log(homedir + constants.BOOKS_PATH)
  return utils.findFiles(homedir + constants.BOOKS_PATH, '/**/*.sqlite'); // {PROBLEM HERE}
}
...
function formatBook(rawTableData) {
  return {
    bookID:rawTableData.ZASSETID, // I ADDED THIS LINE
